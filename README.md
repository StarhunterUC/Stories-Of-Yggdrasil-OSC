# Stories Of Yggdrasil OSC v0.8.8
...
Unity Contact Tool v0.5.6 is required for aligned Attack and Debuff Contacts. Avatars generated by v0.5.1 or v0.5.2 should run the Unity tool's spell-contact repair before testing spell hits.

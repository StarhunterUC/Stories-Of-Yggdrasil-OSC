...
Write-Host "Preparing Stories Of Yggdrasil OSC Desktop v0.8.16..."
...
Copy-Item README.md, QUICK_START.md, CHANGELOG.md, PATCH_NOTES_v0.8.16.md, version.json $ReleaseRoot -Force
Copy-Item contracts (Join-Path $ReleaseRoot "contracts") -Recurse -Force

$Zip = Join-Path $Root "Stories_Of_Yggdrasil_OSC_Windows_v0.8.16.zip"
